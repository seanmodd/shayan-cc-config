...
(async () => {
  ...
  for (const [needle, label] of [
    ...
    ['hpGuideCard', 'the plus first-run guide (what each artifact is, for a newcomer)'],
    ['data-hpgo', 'the guide’s build-one jump buttons'],
    ['hpExample', 'the one-click editable example seeder'],
    ['hpJump', 'the jump-and-flash scroll to a builder panel'],
    ['hpflash', 'the landing flash on a jumped-to panel'],
    ['id="hp-projects"', 'the projects builder jump anchor'],
    ['id="hp-actions"', 'the quick-actions builder jump anchor'],
    ['id="hp-trees"', 'the worktree-layouts builder jump anchor'],
    ['HERDR PLUS — build here', 'the gold group header over the plus builders'],
    ['id="hplHint"', 'the plus-mode editing-happens-below hint chip'],
